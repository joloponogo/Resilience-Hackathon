...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.changeText;
      EditText changeText = ViewBindings.findChildViewById(rootView, id);
      if (changeText == null) {
        break missingId;
      }
      ...
      return new FragmentSecondBinding((ConstraintLayout) rootView, buttonSecond, changeText,
          changer);
    }
